...
function displayScores() {
  ...
  scoreArea.innerHTML = `<h2>High Scores</h2><ul id="highScoresList"></ul><button id="clearScores" class="btn" onclick="clearScores()">Reiniciar</button>`;
...
const questions = [
  {
    question: "aritmetica pregunta 1",
    answers: [
  ...
  {
    question: "arit pregunta 2",
    answers: [
      { text: "conjuntos", correct: false },
      { text: "progresiones", correct: false },
      { text: "secuencia", correct: false },
